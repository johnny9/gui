...
class Binaries:
    ...
    def qml_argv(self):
        "Return argv array that should be used to invoke bitcoin-qml"
        if self.bin_dir is not None:
            return [os.path.join(self.bin_dir, os.path.basename(self.paths.bitcoinqml))]
        return self.valgrind_cmd + [self.paths.bitcoinqml]
